...
float giroMonito = 0;
float rotBrIzq = 0, rotBrDer = 0, rotRodDer = 0; //variables para rotacion de brazos
...
void keyboard(unsigned char key, int x, int y)  // Create Keyboard Function
{
	...
	case 'k': //aqui se guarda el movimiento de animacion
	case 'K':
	...
	case 'l': //aqui se da inicio a la rutina de animacion
	case 'L':
	...
	case 'b': //pie izquierdo hacia atras
		rotRodIzq++;
		printf("%f \n", rotRodIzq);
		break;

	case 'B': //pie izquierdo hacia adelante
		rotRodIzq--;
		printf("%f \n", rotRodIzq);
		break;

	case 'p': //giro completo a la derecha
		giroMonito++;
		break;

	case 'P': //giro completo a la izquierda
		giroMonito--;
		break;

	case 'i': //brazo izquierdo hacia abajo
		rotBrIzq++;
		break;

	case 'I': //brazo izquierdo hacia arriba
		rotBrIzq--;
		break;

	case 'o': //brazo derecho hacia arriba
		rotBrDer++;
		break;

	case 'O': //brazo derecho hacia abajo
		rotBrDer--;
		break;

	case 'm': //pie derecho hacia atras
		rotRodDer++;
		break;

	case 'M': //pie derecho hacia adelante
		rotRodDer--;
		break;
